...
//
import VehiclesDetails from "@/components/explore/vehiclesDetails/vehiclesDetails";
...
export default function VehiclePage({ params }: { params: { id: string } }) {
  ...
  if (!car) {
    return (
      <div className="text-center h-[400px] text-white">
        <h2 className="md:text-6xl text-4xl font-bold mb-4">Vehicle Not Found</h2>
        <p className="text-xl font-semibold">The requested vehicle could not be found.</p>
      </div>
    );
  }
  ...
  return (
    <>
      <div className="text-center h-[400px] text-white">
        <h2 className="md:text-6xl text-4xl font-bold mt-4">Vehicles : {car.title}</h2>
      </div>
      <div className="bg-slate-100 full w-full mx-auto p-10">
        <VehiclesDetails
          title={car.title}
